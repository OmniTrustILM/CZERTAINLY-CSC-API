...
public class OpenApiConfiguration {
    ...
    public GroupedOpenApi cscApis() {
        return GroupedOpenApi.builder()
                             .group("csc-api")
                             .packagesToScan("com.otilm.csc.controllers")
                             //.pathsToMatch("/v1/**")
                             .build();
    }
    ...
    public OpenAPI cscOpenAPI() {
        ...
        logoExtensionFields.put("url",
                                "https://raw.githubusercontent.com/OmniTrustILM/ilm/main/icon/ot-icon-color.svg"
        );
        logoExtension.put("x-logo", logoExtensionFields);

        return new OpenAPI()
                .info(new Info().title("ILM CSC API")
